...
/**
 * [Module] of [ritwik.samples.spacex.ui.activity.LauncherActivity].
 *
 *
 * The purpose of creating a [Module] for [ritwik.samples.spacex.ui.activity.LauncherActivity]
...
class LauncherModule {
    ...
    /**
     * Provides the Repository of [ritwik.samples.spacex.mvvm.viewModel.LauncherViewModel].
     *
     ...
     * @return New Instance of [LauncherRepository].
     */
    @Provides
    ...
    ): LauncherRepository = LauncherRepository(restInterface, dataStorePreference, moshi, resourceUtils)

    /**
     * Provides the Model of [ritwik.samples.spacex.mvvm.viewModel.LauncherViewModel].
     *
     * @return New Instance of [LauncherModel].
     */
    @Provides
    fun providesModel(): LauncherModel = LauncherModel()

...
data class LaunchResponse(
    @field: Json(name = "fairings") val fairings: LaunchFairings?,
    ...
    @field: Json(name = "failures") val failures: List<LaunchFailure>?,
    ...
    @field: Json(name = "cores") val cores: List<LaunchCore>,
...
data class LaunchLinks(
    @field: Json(name = "patch") val patch: LaunchLinkPatch?,
    @field: Json(name = "reddit") val reddit: LaunchLinkReddit?,
    @field: Json(name = "flickr") val flickr: LaunchLinkFlickr?,
